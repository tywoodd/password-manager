...
class Ui_EntryEditorDialog(object):
    def setupUi(self, EntryEditorDialog):
        ...
        self.togglePwdButton2 = QToolButton(self.retypePasswordWidget)
        self.togglePwdButton2.setObjectName(u"togglePwdButton2")
        self.togglePwdButton2.setIcon(icon)

        self.horizontalLayout_7.addWidget(self.togglePwdButton2)
        ...
        self.formLayout.setWidget(6, QFormLayout.ItemRole.FieldRole, self.notesWidget)

        self.notesLabel = QLabel(self.formContainer)
        self.notesLabel.setObjectName(u"notesLabel")

        self.formLayout.setWidget(6, QFormLayout.ItemRole.LabelRole, self.notesLabel)
        ...
        QWidget.setTabOrder(self.retypePasswordEdit, self.togglePwdButton2)
        QWidget.setTabOrder(self.togglePwdButton2, self.notesEdit)
